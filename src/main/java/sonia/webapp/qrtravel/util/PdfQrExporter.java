...
{
  public static void createQrPage( PdfDocument pdf, Document document, PdfPage page, 
		  String roomType, String roomName, String url, String urlPrint, String pin, boolean withSeat
		  , String seat)
    throws IOException
  {
    ...
    image = new Image(ImageDataFactory.create(PdfQrExporter.class.getResource(
	...
	public static void generateDocument(PdfWriter writer, String roomType, String roomName, String url, String pin
		...
		createQrPage( pdf, document, page, 
				  roomType, roomName, url+"&p="+pin, url, pin, false, null);
        ...
        for (int row = 1 ; row <= rows; row++) {
            for (int column = 0 ; column < columns; column++) {
        		...
        		createQrPage( pdf, document, page, 
      				  roomType, roomName, url+"?p="+pin+"&l="+platz, url, pin, true, platz);
	...
	public static void main(String... args) throws IOException {
		...
		generateDocument(new PdfWriter(args[0]), "Klausur" , 
				args[1], "https://qr.sonia.de/", 
				args[2],
