...
public class PdfQrExporter
{
  ...
  public static void createQrPage(PdfDocument pdf, Document document,
    ...
    String url, String urlPrint, String pin, boolean withSeat, String seat)
    throws IOException
  {
    ...
    throws IOException
  {
    ...
    createQrPage(pdf, document, page, roomType, roomName, url + "&p=" + pin, url,
      pin, false, null);
    ...
    int rows, int columns) throws IOException
  {
    ...
    for (int row = 1; row <= rows; row++)
    {
      for (int column = 0; column < columns; column++)
      {
        ...
        createQrPage(pdf, document, page, roomType, roomName, url + "?p=" + pin
          + "&l=" + platz, url, pin, true,
          platz);
  ...
  public static void main(String... args) throws IOException
  {
    ...
    {
      System.out.println(
        "5 Arguments: destFile roomdescription PIN rows columns");
    }
    
    generateDocument(new PdfWriter(args[0]), "Klausur", args[1],
      "https://qr.sonia.de/", args[2],
